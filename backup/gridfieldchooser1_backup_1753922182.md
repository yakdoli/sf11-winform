...
[](ms-xhelp:///?Id=1ef6ae80-cc58-4325-9a30-904da3cbfbf0){#D2HPrevious .D2HPreviousEnabled}  [](ms-xhelp:///?Id=6048f504-3fbb-4508-b56d-fdad4095a65f){#D2HNext .D2HNextEnabled}
:::
::::
:::::
...
| []{style="FONT-FAMILY: 'Courier New'; COLOR: black"}                                                                                                                                                                    |
|                                                                                                                                                                                                                         |
| [Dim]{style="FONT-FAMILY: 'Courier New'; COLOR: blue"}[ fchooser [As]{style="COLOR: blue"} [New]{style="COLOR: blue"} FieldChooser([Me]{style="COLOR: blue"}.gridGroupingControl1)]{style="FONT-FAMILY: 'Courier New'"} |
+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
![](ImagesExt/image91_519.jpg){border="0"}

[]{style="FONT-FAMILY: 'Trebuchet MS','sans-serif'; COLOR: #15428b; FONT-SIZE: 9pt"} 

*[Figure ]{style="FONT-SIZE: 9pt"}[467]{style="FONT-SIZE: 9pt"}[: Grid Grouping control with Field Dialog Box]{style="FONT-SIZE: 9pt"}*
