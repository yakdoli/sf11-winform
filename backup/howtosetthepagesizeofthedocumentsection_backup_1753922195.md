...
[](ms-xhelp:///?Id=11ab428b-451e-4ed5-aab8-3e9cee0dc46b){#D2HPrevious .D2HPreviousEnabled}  [](ms-xhelp:///?Id=ada4eb5f-8b06-4409-ab2a-ddbc1f54f119){#D2HNext .D2HNextEnabled}
:::
::::
:::::
...
|                                                                                                                       |
| [document.Sections\[0\].PageSetup.PageSize = [PageSize]{style="COLOR: teal"}.B6;]{style="FONT-FAMILY: 'Courier New'"} |
+-----------------------------------------------------------------------------------------------------------------------+
...
|                                                                                             |
| [document.Sections(0).PageSetup.PageSize = PageSize.B6]{style="FONT-FAMILY: 'Courier New'"} |
+---------------------------------------------------------------------------------------------+
