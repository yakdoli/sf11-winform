...
|                                                                                                                                                                                                                                                                                           |
| [                ]{style="FONT-FAMILY: 'Courier New'"}[AllowSorting = [true]{style="COLOR: blue"}]{style="FONT-FAMILY: 'Courier New'; FONT-SIZE: 11pt"}                                                                                                                                   |
|                                                                                                                                                                                                                                                                                           |
...
Figure 53: Grid---Sorting

6.  Click on the column heading to sort them in ascending or descending order, the content will be ordered in ascending order on the first click, then by descending order on the next click.

 

![Description: C:\\Users\\thivyak\\Desktop\\Sorting.png](ImagesExt/image107_50.jpg){border="0"}

Figure 54: Grid---Sorting
