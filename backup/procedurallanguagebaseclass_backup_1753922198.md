...
[](ms-xhelp:///?Id=c3d8bb64-e9b7-4819-994a-e0e28dcdc48c){#D2HPrevious .D2HPreviousEnabled}  [](ms-xhelp:///?Id=f6837d5b-9876-43c5-badf-23d9675db01f){#D2HNext .D2HNextEnabled}
:::
::::
:::::
...
### ProceduralLanguageBase Class  {#procedurallanguagebase-class style="tab-stops: 0pt"}
...
ProceduralLanguageBase class can be directly used as a base class for implementing a custom language. Refer to [Custom Language Support](ms-xhelp:///?Id=967b544f-600e-4fd2-9a21-e6deedd71b37) topic for more information on how to create custom language in EditControl. Also refer to [C#](ms-xhelp:///?Id=1f757a63-dc6b-4951-b865-d5ec71496d6e) and [Visual Basic](ms-xhelp:///?Id=91b4f7cf-df58-4033-80a3-1f053befc426) Language Configurations topic to know more about the implementations of C# and Visual Basic language support in EditControl.
