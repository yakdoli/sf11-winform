...
2.   Define the ShowThumb and ThumbStyle property and pass the instance through the view-specific data to the view.[]{style="FONT-FAMILY: Consolas; FONT-SIZE: 9.5pt"}
...
|                                                                                                                                                                           |
| [            **slider.ShowThumb = [true]{style="COLOR: blue"};**]{style="FONT-FAMILY: 'Courier New'"}                                                                     |
|                                                                                                                                                                           |
| **[            slider.Thumb = [ThumbStyle]{style="COLOR: #2b91af"}.Diamond;]{style="FONT-FAMILY: 'Courier New'"}**                                                        |
|                                                                                                                                                                           |
...
[ ![Description: C:\\Users\\krishnarajd\\Desktop\\thumb.png](ImagesExt/image103_219.jpg){border="0"} ]{style="LINE-HEIGHT: 115%; FONT-FAMILY: 'Calibri','sans-serif'; FONT-SIZE: 11pt"}

Figure 137: Slider with Diamond Thumb style[]{style="FONT-FAMILY: 'Calibri','sans-serif'; FONT-SIZE: 11pt"}
