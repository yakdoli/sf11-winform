...
|                                                                                                                                                              |
| [              }).**Legend(legend =\> legend.Visible(true).Shape(LegendShape.Rectangle))**.ElementSpacing(10).Render();]{style="FONT-FAMILY: 'Courier New'"} |
|                                                                                                                                                              |
...
![Description: C:\\Users\\rubyp\\AppData\\Local\\Temp\\Rar\$DI24.736\\Line chart.png](ImagesExt/image106_84.jpg){border="0"}
