...
[\
]{style="FONT-FAMILY: 'Calibri','sans-serif'"}The steps to customize ScheduleMode using SchedulePropertiesModel are as follows:
...
2.   [Add the following code in the Index.aspx file, to create the **Schedule** control in **View**]{.NumberedListChar}[.]{style="FONT-FAMILY: 'Calibri','sans-serif'"}
...
|                                                                                                                                                                                                                                            |
| **[scheduleModel.ScheduleMode = [ScheduleMode]{style="COLOR: #2b91af"}.Vertical;]{style="FONT-FAMILY: 'Calibri','sans-serif'"}**                                                                                                           |
|                                                                                                                                                                                                                                            |
