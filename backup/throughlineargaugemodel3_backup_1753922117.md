...
| []{style="FONT-FAMILY: 'Courier New'"}                                                                                                                                                  |
|                                                                                                                                                                                         |
| [           [// Creating marker Pointer.]{style="COLOR: green"}]{style="FONT-FAMILY: 'Courier New'"}                                                                                    |
|                                                                                                                                                                                         |
...
| []{style="FONT-FAMILY: 'Courier New'"}                                                                                                                                                  |
|                                                                                                                                                                                         |
| [            [//Creating Bar pointer.]{style="COLOR: green"}]{style="FONT-FAMILY: 'Courier New'"}                                                                                       |
|                                                                                                                                                                                         |
...
|                                                                                                                                                                                         |
| [            [//Adding Bar Pointer to the linear scale.]{style="COLOR: green"}]{style="FONT-FAMILY: 'Courier New'"}                                                                     |
|                                                                                                                                                                                         |
| [            l_Scale.Pointers.Add(b_Pointer);]{style="FONT-FAMILY: 'Courier New'"}                                                                                                      |
|                                                                                                                                                                                         |
| [            [//Adding Marker Pointer to the linear scale.]{style="COLOR: green"}]{style="FONT-FAMILY: 'Courier New'"}                                                                  |
|                                                                                                                                                                                         |
...
![Description: C:\\Users\\krishnarajd\\Desktop\\Documents_Updated\\GaugeImages\\pointer_L.png](ImagesExt/image57_96.png){border="0"}

Figure 104: Linear Gauge with Marker and Bar Pointer**[]{style="FONT-FAMILY: 'Calibri','sans-serif'"}**
