...
1.   C[reating]{style="FONT-FAMILY: 'Calibri','sans-serif'"} a model in the application.[ ]{style="FONT-FAMILY: 'Calibri','sans-serif'"}
...
|                                                                                                                                                                                                                                            |
| [            };]{style="FONT-FAMILY: 'Calibri','sans-serif'"}[]{style="FONT-FAMILY: 'Calibri','sans-serif'; FONT-SIZE: 9.5pt"}                                                                                                             |
|                                                                                                                                                                                                                                            |
| []{style="FONT-FAMILY: 'Calibri','sans-serif'"}                                                                                                                                                                                            |
|                                                                                                                                                                                                                                            |
...
|                                                                                                                                                                                                                                            |
| **[            scheduleModel.ShowPrint = [true]{style="COLOR: blue"};]{style="FONT-FAMILY: 'Calibri','sans-serif'"}**                                                                                                                      |
|                                                                                                                                                                                                                                            |
| **[            scheduleModel.ContextMenuItems = [new]{style="COLOR: blue"} [List]{style="COLOR: #2b91af"}\<[ContextMenuItem]{style="COLOR: #2b91af"}\>() { quickPrint };]{style="FONT-FAMILY: 'Calibri','sans-serif'"}**                   |
|                                                                                                                                                                                                                                            |
