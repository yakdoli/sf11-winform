...
[](ms-xhelp:///?Id=a522b0f0-ded7-4553-900f-0e60c837e66e){#D2HPrevious .D2HPreviousEnabled}  [](ms-xhelp:///?Id=94ec5d3e-1eb1-4c8e-b7c3-bfdffc59b290){#D2HNext .D2HNextEnabled}
:::
::::
:::::
...
[]{style="FONT-FAMILY: 'Trebuchet MS','sans-serif'; COLOR: #15428b; FONT-SIZE: 9pt"} 
  ...
  AllowRotate   Gets or sets a value indicating whether a node can be rotated or not. The default value is set to true.   Dependency property    Boolean (true/ false)   No[]{style="FONT-FAMILY: 'Courier New'"}
  ------------- --------------------------------------------------------------------------------------------------------- ---------------------- ----------------------- ---------------------------------------------------
...
![](ImagesExt/image62_39.jpg){border="0"}

Figure 32: Node Rotation**[]{style="FONT-STYLE: normal; FONT-FAMILY: 'Trebuchet MS','sans-serif'; COLOR: #15428b"}**
...
![Description: C:\\Users\\ramyathirugnanam\\Desktop\\Node Rotation.PNG](ImagesExt/image62_40.png){border="0"}
...
![](ImagesExt/image62_41.png){border="0"}
