...
[](ms-xhelp:///?Id=1f1c7f8b-6af4-4616-b2ab-bd8384b62ca4){#D2HPrevious .D2HPreviousEnabled}  [](ms-xhelp:///?Id=3dba452d-f4b8-4001-8521-3d281a0c62d5){#D2HNext .D2HNextEnabled}
:::
::::
:::::
...
| []{style="FONT-FAMILY: 'Courier New'; COLOR: black"}                                                                                                                             |
|                                                                                                                                                                                  |
| [Dim]{style="FONT-FAMILY: 'Courier New'; COLOR: blue"}[ cp[ As New ]{style="COLOR: blue"}Syncfusion.Windows.Forms.Diagram.ConnectionPoint()]{style="FONT-FAMILY: 'Courier New'"} |
|                                                                                                                                                                                  |
| [cp.ConnectionsLimit = 12]{style="FONT-FAMILY: 'Courier New'"}                                                                                                                   |
+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
