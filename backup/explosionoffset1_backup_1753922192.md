...
##### Explosion Offset {#explosion-offset style="tab-stops: 0pt"}

Explosion Offset gets or sets the offset value that is to be used when slices are to be exploded in a Pie chart.
...
Pie chart with Explosion Offset can be created through two ways:
...
###### 5.2.1.2.5.1 Builder {#builder style="tab-stops: 0pt"}

[]{style="FONT-FAMILY: 'Calibri','sans-serif'"} 

To create a Pie chart and set its ExplosionOffset property through Builder:
...
5.   Set the ExplosionOffset property, as specified in the code snippets displayed below.
...
![](ImagesExt/image69_121.png){border="0"}

Figure 163: Pie chart with Exploded Index 2 and Explosion Offset 30f

[]{style="FONT-FAMILY: Consolas; BACKGROUND: yellow; FONT-SIZE: 9.5pt"} 

[                ]{style="FONT-FAMILY: 'Calibri','sans-serif'"}

###### 5.2.1.2.5.2 ChartModel {#chartmodel style="tab-stops: 0pt"}

[]{style="FONT-FAMILY: 'Calibri','sans-serif'"} 

To create a Pie chart and set its ExplosionOffset property through ChartModel:
...
4.   Set the ExplosionOffset property, as specified in the code displayed below.

5.   [series1.ExplosionOffset = 30f;]{style="FONT-FAMILY: Consolas; FONT-SIZE: 9.5pt"}
...
Figure 164: Pie chart with Exploded Index 2 and Explosion Offset 30f
