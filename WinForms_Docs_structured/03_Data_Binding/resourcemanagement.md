...
original_path: c:/workspace/sf11-winform/WinForms_Docs\03_Data_Binding\resourcemanagement.md
...
[Many web developers will most probably be aware of various website optimization techniques described in Yahoo Developer Network article (Refer to ][[http://developer.yahoo.com/performance/rules.html]{.UGHyperlink}](http://developer.yahoo.com/performance/rules.html)[). ]
