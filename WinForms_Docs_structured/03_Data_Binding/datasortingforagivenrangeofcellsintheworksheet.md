---
title: datasortingforagivenrangeofcellsintheworksheet.md
original_path: WinForms_Docs/03_Data_Binding/datasortingforagivenrangeofcellsintheworksheet.md
...
{border="0"}Note: Presently we don't support sorting based on cell icon, parsing and serialization of the sorting details.
