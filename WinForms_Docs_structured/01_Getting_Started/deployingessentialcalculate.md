---
title: deployingessentialcalculate.md
original_path: WinForms_Docs/01_Getting_Started/deployingessentialcalculate.md
...
We have now created a platform application in the previous topic ().
