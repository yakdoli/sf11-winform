---
title: samplesaddon.md
original_path: WinForms_Docs/01_Getting_Started/samplesaddon.md
...
8.   Click **Next**. The [**[Select]**]{.MsoSubtleEmphasis} **the Installation Folder** screen opens.
