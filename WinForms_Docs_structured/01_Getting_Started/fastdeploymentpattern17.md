---
title: fastdeploymentpattern17.md
original_path: c:/workspace/sf11-winform/WinForms_Docs\01_Getting_Started\fastdeploymentpattern17.md
...
{border="0"}Note: If you do not want to delete the Syncfusion assembly GAC entries, then in Web.config file  remove the Culture, Version and PublicKeyToken attributes used in all [\<][assemblies][\>,\<][httpHandlers][\>] and [\<][handlers][\> ]nodes. 
