---
title: viewingsamples13.md
original_path: WinForms_Docs/01_Getting_Started/viewingsamples13.md
...
[·      ] **Run Samples** - View the locally installed Tools samples for ASP.NET MOBILE MVC using the sample browser

[·      ] **Online Samples** - View the online Tools samples for ASP.NET MOBILE MVC
...
[·      ] **Release Notes** - View the release notes of ASP.NET MOBILE MVC
