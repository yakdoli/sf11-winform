---
title: creatingdiagramcontrolthroughdesigner1.md
original_path: WinForms_Docs/04_Controls/Diagram/creatingdiagramcontrolthroughdesigner1.md
...
Kindly refer to  and  to add the model and view to the control.
