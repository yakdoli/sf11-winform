---
title: griddatacontrol.md
original_path: c:/workspace/sf11-winform/WinForms_Docs\04_Controls\Grid\griddatacontrol.md
...
{border="0"}Note: There are several other classes that assist the user in creating groups, summaries, filters, sorted columns, etc.
...
[·      ]Data Model-This discusses the ICollectionViewAdv interface.
