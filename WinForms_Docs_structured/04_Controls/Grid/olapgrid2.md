---
title: olapgrid2.md
original_path: WinForms_Docs/04_Controls/Grid/olapgrid2.md
...
OLAP Grid control is embedded into the OLAP Client to visualize the OLAP data buried in OLAP Cubes. The categorical axis defines one or more dimensions that are displayed along the columns in a Grid. If more than one dimension is present on the categorical axis, each data point will be defined by a unique combination of the dimensions\' members.
