---
title: creatingthegridcontrolintheview.md
original_path: c:/workspace/sf11-winform/WinForms_Docs\04_Controls\Grid\creatingthegridcontrolintheview.md
...
1.   Create a model in the application (Refer to [Getting Started\>Adding a Model to the Application]{.UGHyperlink}[[)]]{.UGHyperlink}[[.]]{.UGHyperlink}
