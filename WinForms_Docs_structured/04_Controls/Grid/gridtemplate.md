---
title: gridtemplate.md
original_path: WinForms_Docs/04_Controls/Grid/gridtemplate.md
...
1.   [Open a new **Grid MVC Project** template, which is fully configured for Grid Control. Refer]{.BodyText1Char} to **[MVC Project Template]**.
...
4.   [The following image illustrates how to select the Grid Template.]
...
7.   [Refer to ][[Grid MVC UG]](http://help.syncfusion.com/ug_83/User%20Interface/ASP.NET%20MVC/Grid/index.htm)[, for further customization.]
