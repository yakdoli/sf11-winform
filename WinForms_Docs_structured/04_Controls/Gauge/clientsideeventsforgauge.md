---
title: clientsideeventsforgauge.md
original_path: WinForms_Docs/04_Controls/Gauge/clientsideeventsforgauge.md
...
The events for circular and linear gauges are all common. This section contains all of the events that are applicable for Circular and Linear gauges.
  ...
  -------------------------------------------------- --------------------------------------------------------------------------------- ----------------------------------------- ---------------------------------------- ---------------------------------------------------------
  ClientSideOnDrawTicks []   Event fired when drawing each tick marks in the gauge[]   [ ]Sender, args   [ ]Client-Side   [ ]NA[]
  ClientSideOnDrawLabels                             Event fired when drawing each labels in the gauge                                 Sender,args                               Client-Side                              NA
  ClientSideOnDrawPointers                           Event fired when drawing each pointers in the gauge                               Sender,args                               Client-Side                              [ ]NA
  ClientSideOnDrawRange                              Event fired when drawing each ranges in the gauge                                 Sender,args                               Client-Side                              NA[]
