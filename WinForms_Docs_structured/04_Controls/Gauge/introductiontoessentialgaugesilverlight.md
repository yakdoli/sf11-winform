---
title: introductiontoessentialgaugesilverlight.md
original_path: c:/workspace/sf11-winform/WinForms_Docs\04_Controls\Gauge\introductiontoessentialgaugesilverlight.md
...
[·      ]**Digital Gauge**-Essential Gauge Silverlight is used to display any value in the segment display manner. The data given in the control is clearly depicted as it will be similar to alpha numeric representation.
