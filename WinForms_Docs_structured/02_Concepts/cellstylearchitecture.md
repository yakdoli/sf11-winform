---
title: cellstylearchitecture.md
original_path: WinForms_Docs/02_Concepts/cellstylearchitecture.md
...
#### Cell Style Architecture {#cell-style-architecture style="tab-stops: 0pt"}
