---
title: addingstylemanager5.md
original_path: c:/workspace/sf11-winform/WinForms_Docs\02_Concepts\addingstylemanager5.md
...
Add the **StyleManager** extension method in the HEAD element of the view pages (in most cases, it is reasonable to call it within the **\_Layout.cshtml page**). Use the **Register** method to register the Grid component.[]
