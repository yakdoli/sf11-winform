---
title: featuresummary33.md
original_path: WinForms_Docs/02_Concepts/featuresummary33.md
...
{border="0"}Note: The above specified import and export features are not supported in Silverlight application.
