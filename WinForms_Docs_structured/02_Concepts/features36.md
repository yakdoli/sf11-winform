---
title: features36.md
original_path: c:/workspace/sf11-winform/WinForms_Docs\02_Concepts\features36.md
...
Text can be selected, formatted, clipped and displayed from right to left using the [[text settings]{.UGHyperlink}](http://help.syncfusion.com/ug_82/WindowsFormsUI_Tools/TextSettings5.html) of the IntegerTextBox control.[]
