---
title: features33.md
original_path: c:/workspace/sf11-winform/WinForms_Docs\02_Concepts\features33.md
...
The [[display]{.UGHyperlink}](http://help.syncfusion.com/ug_82/WindowsFormsUI_Tools/PercentSettings.html) settings involve setting the separator to be used to group the numbers and the group size.[]
...
The [[value settings]](http://help.syncfusion.com/ug_82/WindowsFormsUI_Tools/ValueSettings.html) provide options to set the value to be displayed by the PercentTextBox control. It provides options to indicate the null state of the control and customize its settings.[]
...
Text can be selected, formatted, clipped, aligned and displayed from right to left using the [[text settings]](http://help.syncfusion.com/ug_82/WindowsFormsUI_Tools/TextSettings11.html) of the PercentTextBox control.[]
...
Keyboard support for entering large values is provided. Incrementing and decrementing of values can be done using the up and down arrow [[keys]](http://help.syncfusion.com/ug_82/WindowsFormsUI_Tools/KeySettings1.html).[]
