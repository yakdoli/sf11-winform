---
title: applyingstylestothet.md
original_path: WinForms_Docs/02_Concepts/applyingstylestothet.md
...
[·      ]**General** to change the name and value of the text box.

[·      ]**Alignment** to set the horizontal alignment, vertical alignment, and padding of the text box.

[·      ]**Font** to set the font family, font size, font color, font style, font effects, and line spacing of the text box.

[·      ]**Fill** to set the background color of the text box.

[·      ]**Visibility** to set the visibility of the text box when the report is initially run.

[] 

{border="0"}

Figure 31: Text Box Properties Dialog[]
...
Figure 34: Changing Styles of the Text Box through the Properties Grid[]
