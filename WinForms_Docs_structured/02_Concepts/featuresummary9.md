---
title: featuresummary9.md
original_path: WinForms_Docs/02_Concepts/featuresummary9.md
...
[·      ]24 Hours - Display appointments with 24 hours format\
\
...
Essential Schedule allows you to add multiple resources to the control. You can assign appointments to each resource.[[ ]]{.Heading1Char}Resource header will help you to view the appointments for each resource with a resource name as the header.
