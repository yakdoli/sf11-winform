---
title: featuresoverview10.md
original_path: WinForms_Docs/02_Concepts/featuresoverview10.md
...
[·      ]**Styles Architecture** - Supports a flexible [[[style architecture]]{.UGHyperlink}](../../../../../../../../Documents%20and%20Settings/sylviap/Desktop/Tools%20-%20Part%202.docx#_Styles_Architecture_1) to let users define the styles for nodes at different levels of the Tree. It helps the users to specify the styles for a specific node or for a class of nodes.

 

[·      ]**Columns** - Lets you add [[multiple columns]](../../../../../../../../Documents%20and%20Settings/sylviap/Desktop/Tools%20-%20Part%202.docx#_Multiple_Columns) and [[subitems]](../../../../../../../../Documents%20and%20Settings/sylviap/Desktop/Tools%20-%20Part%202.docx#_SubItems).
...
[o  ]**LabelEdit***[ -]* property that helps users to easily edit the node text at run time.

[o  ]**Nodes selection** - allows to select a single node or select all the nodes or only the specified nodes.

[o  ]**OwnerDrawNodes** - property that allows user to paint the background of the node.

[o  ]**Text Color** - option to customize node text color.

[o  ]**Font** - option to change the node\'s font.

[o  ]**Helptext** - can be enabled for each and every nodes in the first column. Each nodes can display its own information.
...
[·      ]**Custom Control -[ ]**Support for custom control feature allows to add custom controls to the tree node of the first column alone. See [[custom control]](../../../../../../../../Documents%20and%20Settings/sylviap/Desktop/Tools%20-%20Part%202.docx#_Custom_Controls) for details.
