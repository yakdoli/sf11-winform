---
title: basiccorefeatures1.md
original_path: c:/workspace/sf11-winform/WinForms_Docs\02_Concepts\basiccorefeatures1.md
...
[·      ]**SelectionChanged --** An event handler. This will be triggered when the currently selected item in the AutoComplete Control is changed** **

[·      ]**TextChanged**- An Event Handler. This will be triggered when the user edits the text in the AutoComplete controls's textbox.  
...
| **[\[C#\]]**                                                                                                                                                                         |
|                                                                                                                                                                                                                          |
| [autoComplete.SelectionChanged += [new] [SelectionChangedEventHandler](autoComplete_SelectionChanged);]                                 |
|                                                                                                                                                                                                                          |
...
| []                                                                                                                                                                                   |
|                                                                                                                                                                                                                          |
| [            [this].textBlock1.Text = autoComplete.SelectedValue.ToString();           ]                                                                        |
|                                                                                                                                                                                                                          |
| [        }]                                                                                                                                                                          |
|                                                                                                                                                                                                                          |
| []                                                                                                                                                                                   |
