---
title: features37.md
original_path: c:/workspace/sf11-winform/WinForms_Docs\02_Concepts\features37.md
...
2D and 3D border styles can be applied to the NumericUpDownExt. The color of the border can be set for the control using the**BorderColor** property.[]
