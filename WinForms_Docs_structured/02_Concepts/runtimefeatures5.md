---
title: runtimefeatures5.md
original_path: WinForms_Docs/02_Concepts/runtimefeatures5.md
...
{border="0"} Note: Context Menu, Hot Tracking and Tooltip features can be applied only to the nodes in the first column.
