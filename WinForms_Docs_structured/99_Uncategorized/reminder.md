---
title: reminder.md
original_path: c:/workspace/sf11-winform/WinForms_Docs\99_Uncategorized\reminder.md
...
### [Reminder] {#reminder style="MARGIN-TOP: 0pt; tab-stops: 0pt"}
...
Table 13: Reminder - Properties**[]**


+---------------+---------------------------------------------------------+----------------------+--------------------------------------+------------------------------------------+
| Property      | Description                                             | Type of the property | Value it accepts                     | Dependency                               |
+===============+=========================================================+======================+======================================+==========================================+
| AllowReminder | Used to enable create/update appointment with reminder. | Boolean              | [True/False] | Dependent with AllowAddNew and AllowEdit |
|               |                                                         |                      |                                      |                                          |
|               |                                                         |                      |                                      |                                          |
+---------------+---------------------------------------------------------+----------------------+--------------------------------------+------------------------------------------+
