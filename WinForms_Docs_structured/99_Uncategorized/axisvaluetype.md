---
title: axisvaluetype.md
original_path: c:/workspace/sf11-winform/WinForms_Docs\99_Uncategorized\axisvaluetype.md
...
| **[]**                                                                                                                                   |
|                                                                                                                                                                                            |
| [this][.ChartWebControl1.PrimaryXAxis.ValueType = [ChartValueType].Logarithmic;] |
|                                                                                                                                                                                            |
| [this][.ChartWebControl1.PrimaryXAxis.LogBase = 3;]                                                   |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
