---
title: aboutonlineanalyticalprocessingolap.md
original_path: c:/workspace/sf11-winform/WinForms_Docs\99_Uncategorized\aboutonlineanalyticalprocessingolap.md
...
  
   ...
   [ \> ]{.d2h_breadcrumbsLinkSeparator} [Essential BI Gauge]{.d2h_breadcrumbsContentsOnly}
...
Here is how Wikipedia defines [[OLAP]{.UGHyperlink}](http://en.wikipedia.org/wiki/Olap).[]
