---
title: clipboardcancopy1.md
original_path: c:/workspace/sf11-winform/WinForms_Docs\99_Uncategorized\clipboardcancopy1.md
...
1.   The grid cell data and range of cells that is going to be moved to the clipboard can be accessed by using the **DataObject** and **RangeList** properties.
