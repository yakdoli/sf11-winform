---
title: backgroundsettings.md
original_path: WinForms_Docs/99_Uncategorized/backgroundsettings.md
...
{border="0"}Note:[ ]Refer the [Text Border]{.UGHyperlink} topic to know how to set the border for the text.
