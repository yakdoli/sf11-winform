---
title: introductiontoessentialolapclientweb.md
original_path: WinForms_Docs/99_Uncategorized/introductiontoessentialolapclientweb.md
...
[ ]{.UGHyperlink}**current session** - You can save your current session in an XML file format and reload it whenever needed.

[·      ]**Drill down/up support** - The Grid and Chart controls let you drill down/up the hierarchies natively.

 - You can also export the Grid and Chart to MS-Excel and Word formats.
