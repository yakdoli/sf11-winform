---
title: formulavalidator1.md
original_path: c:/workspace/sf11-winform/WinForms_Docs\99_Uncategorized\formulavalidator1.md
...
If the **Display Computable Formulas** is not selected, then the results will not include the formulae that are used in the spreadsheet.[]

4.   You can export a spreadsheet by using the **Export** option**,** after selecting the file that is to be exported.[]
