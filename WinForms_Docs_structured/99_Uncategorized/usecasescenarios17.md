---
title: usecasescenarios17.md
original_path: c:/workspace/sf11-winform/WinForms_Docs\99_Uncategorized\usecasescenarios17.md
...
###### 3.30.6.6.1.1        Tables for Properties {#tables-for-properties style="tab-stops: 0pt"}
  ...
  **Property**                                   **Description**                                                                          **Type**                                                                           **Data Type**
  PropertyExpandMode[]   Gets or sets the PropertyExpandMode[]   Dependency[]   [Enum][]
  ---------------------------------------------- ---------------------------------------------------------------------------------------- ---------------------------------------------------------------------------------- ----------------------------------------------------------------------------------
