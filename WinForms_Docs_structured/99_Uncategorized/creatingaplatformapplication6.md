---
title: creatingaplatformapplication6.md
original_path: c:/workspace/sf11-winform/WinForms_Docs\99_Uncategorized\creatingaplatformapplication6.md
...
3.   Refer [ ]{.UGHyperlink}topic to know how to add XlsIO to the created application.
...
2.   Now you need to deploy Essential XlsIO into this ASP.NET application. Refer [ ]{.UGHyperlink}topic for detailed info.
...
4.   Refer  topic to know how to add XlsIO to the created application.
...
Refer  topic to know how to add XlsIO to the created application.
