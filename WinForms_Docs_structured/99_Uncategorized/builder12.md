---
title: builder12.md
original_path: c:/workspace/sf11-winform/WinForms_Docs\99_Uncategorized\builder12.md
...
To create a Column Range chart through Builder:
...
3.   Add the **Series** to the ChartModel and set the series type to **ColumnRange**, and add the **Points** to the series and set the style.
...
|                                                                                                                                                                                                                                                                                         |
| [                **    series.Add().Type(Syncfusion.Windows.Forms.Chart.[ChartSeriesType]. ColumnRange)**]                                                                                                                  |
|                                                                                                                                                                                                                                                                                         |
| [                                .Text([\"Server 1\"])]                                                                                                                                                                     |
|                                                                                                                                                                                                                                                                                         |
| [                                .Points(point =\>]                                                                                                                                                                                                 |
...
Figure 95: Chart displaying Column Range Series[]
