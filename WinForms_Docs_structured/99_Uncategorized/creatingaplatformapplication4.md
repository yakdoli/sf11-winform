---
title: creatingaplatformapplication4.md
original_path: WinForms_Docs/99_Uncategorized/creatingaplatformapplication4.md
...
{border="0"}Note: The other option becomes unavailable for selection as shown in the following below.
