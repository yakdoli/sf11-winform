---
title: clientobjectid3.md
original_path: c:/workspace/sf11-winform/WinForms_Docs\99_Uncategorized\clientobjectid3.md
...
| []                                                                 |
|                                                                                                                                     |
| [MultiColumnDropDown1.ClientObjectID = [\"Custom ID\"];] |
+-------------------------------------------------------------------------------------------------------------------------------------+
...
| []                                                                                                                                           |
|                                                                                                                                                                                                               |
| [Private][ MultiColumnDropDown1.ClientObjectID = [\"Custom ID\"]] |
+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
