---
title: algebrasupportedinexpressionsfilters.md
original_path: c:/workspace/sf11-winform/WinForms_Docs\99_Uncategorized\algebrasupportedinexpressionsfilters.md
...
{border="0"} Note that spaces that are significant in the list, i.e. {RTR,MAS} is not the same as {RTR, MAS}.
