---
title: usingpropertiesmodel43.md
original_path: c:/workspace/sf11-winform/WinForms_Docs\99_Uncategorized\usingpropertiesmodel43.md
...
The following section explains how to set the date navigation range of the Date Picker using the properties model.
...
| [       \-\-\-\-\-\-\--]                                                                                                                                             |
|                                                                                                                                                                                                          |
| [       model.MinDate = [DateTime].Now.AddMonths(-5);]                                                                                       |
|                                                                                                                                                                                                          |
| [       model.MaxDate = [DateTime].Now.AddMonths(5);]                                                                                        |
|                                                                                                                                                                                                          |
| [       \-\-\-\-\-\-\--]                                                                                                                                             |
|                                                                                                                                                                                                          |
