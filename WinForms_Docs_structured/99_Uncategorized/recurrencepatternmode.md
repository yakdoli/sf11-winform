---
title: recurrencepatternmode.md
original_path: c:/workspace/sf11-winform/WinForms_Docs\99_Uncategorized\recurrencepatternmode.md
...
[·      ]**DailyDays** - Enables you to set the number of day(s) the appointment is repeated.

 

[]{#_Weekly}Weekly

[·      ]**WeeklyWeeks -** Enables users to set the number of week(s), the appointment is repeated in a particular day.
...
[·      ]**IsYearlyCustomDays - Set this t**o **false** to enable Recurrence Appointment for a particular day of the week in a particular month[.]
