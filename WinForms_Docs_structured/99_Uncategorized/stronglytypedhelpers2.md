---
title: stronglytypedhelpers2.md
original_path: c:/workspace/sf11-winform/WinForms_Docs\99_Uncategorized\stronglytypedhelpers2.md
...
| [  ] [\<%] []                                                                                                                                                                                      |
|                                                                                                                                                                                                                                                                                                                                    |
| [ Html.MobSyncfusion().PercentTextBoxFor(x =\> x.EmployeeID).Render(); [%\>]]                                                                                                                                                                                      |
|                                                                                                                                                                                                                                                                                                                                    |
| **[\[Razor\]]**                                                                                                                                                                                                                                                                                |
|                                                                                                                                                                                                                                                                                                                                    |
| [    ] [\@{] [Html.MobSyncfusion().PercentTextBoxFor(x =\> x.EmployeeID).Render();        [}]] [] |
