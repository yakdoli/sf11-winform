---
title: clientobjectid1.md
original_path: c:/workspace/sf11-winform/WinForms_Docs\99_Uncategorized\clientobjectid1.md
...
| []                                                        |
|                                                                                                                            |
| [SpellCheck1.ClientObjectID = [\"Custom ID\"];] |
+----------------------------------------------------------------------------------------------------------------------------+
...
| []                                                                                                                                  |
|                                                                                                                                                                                                      |
| [Private][ SpellCheck1.ClientObjectID = [\"Custom ID\"]] |
+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
