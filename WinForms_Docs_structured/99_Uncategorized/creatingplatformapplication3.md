---
title: creatingplatformapplication3.md
original_path: WinForms_Docs/99_Uncategorized/creatingplatformapplication3.md
...
2.   Now you need to deploy Essential PDF into this Windows application. Refer  topic for detailed info.
...
2.   Now you need to deploy Essential PDF into this ASP.NET application. Refer  topic for detailed info.
...
2.   Now you need to deploy Essential PDF into this WPF application. Refer  topic for detailed info.
...
2.   Refer  topic to know how to deploy Essential PDF document with pages to the application.
...
To know how to add a PDF to this application, refer  topic.
