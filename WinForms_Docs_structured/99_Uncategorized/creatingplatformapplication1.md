---
title: creatingplatformapplication1.md
original_path: c:/workspace/sf11-winform/WinForms_Docs\99_Uncategorized\creatingplatformapplication1.md
...
2.   Now you need to deploy Essential DocIO into this Windows application. Refer  topic for detailed info.
...
2.   Now you need to deploy Essential DocIO into this ASP.NET application. Refer  topic for detailed info.
...
3.   Now you need to deploy Essential DocIO into this WPF application. Refer  topic for detailed info.
...
4.   Refer [t]{.UGHyperlink} topic to know how to deploy Essential DocIO to the application.
...
To know how to deploy Essential DocIO to this application, refer  topic.
