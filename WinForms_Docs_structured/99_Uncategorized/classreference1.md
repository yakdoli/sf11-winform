---
title: classreference1.md
original_path: c:/workspace/sf11-winform/WinForms_Docs\99_Uncategorized\classreference1.md
...
[http://help.syncfusion.com](http://help.syncfusion.com/)[[  ]]{.UGHyperlink}(Navigate to the corresponding UG, and then click the Class Reference link found in the upper right section of the page.)


{border="0"}Note: The online version is usually more up to date than the installed version, since we publish regular updates to the web.
