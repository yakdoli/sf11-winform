---
title: phongalpha.md
original_path: c:/workspace/sf11-winform/WinForms_Docs\99_Uncategorized\phongalpha.md
...
| **[]**                                                                                                                          |
|                                                                                                                                                                                   |
| [this][.ChartWebControl1.Series\[0\].ConfigItems.ColumnItem.PhongAlpha = 2.0;] |
+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
| **[]**                                                                                                                             |
|                                                                                                                                                                                      |
| [Private Me][.ChartWebControl1.Series(0).ConfigItems.ColumnItem.PhongAlpha = 2.0] |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
