---
title: calculating.md
original_path: c:/workspace/sf11-winform/WinForms_Docs\99_Uncategorized\calculating.md
...
### Calculating {#calculating style="tab-stops: 0pt"}
...
{border="0"}Note: The value returned is a string holding the computed quantity.
