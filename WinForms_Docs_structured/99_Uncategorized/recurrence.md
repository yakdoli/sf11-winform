---
title: recurrence.md
original_path: WinForms_Docs/99_Uncategorized/recurrence.md
...
### [Recurrence] {#recurrence style="MARGIN-TOP: 0pt; tab-stops: 0pt"}
...
+-----------------+-----------------------------------------------------+----------------------+--------------------------------------+------------------------------------------+
| AllowRecurrence | Used to enable create/update recurring appointment. | Boolean              | [True/False] | Dependent with AllowAddNew and AllowEdit |
|                 |                                                     |                      |                                      |                                          |
|                 |                                                     |                      |                                      |                                          |
+-----------------+-----------------------------------------------------+----------------------+--------------------------------------+------------------------------------------+
