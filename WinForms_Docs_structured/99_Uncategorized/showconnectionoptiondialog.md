---
title: showconnectionoptiondialog.md
original_path: WinForms_Docs/99_Uncategorized/showconnectionoptiondialog.md
...
| []                                                                                                                             |
|                                                                                                                                                                    |
| [this] [.olapClient1.ShowConnectOptionButton = [false];] |
|                                                                                                                                                                    |
| []                                                                                                                             |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
| [   ]                                                                                                                       |
|                                                                                                                                                                 |
| [Me] [.olapClient1.ShowConnectOptionButton = [False]] |
|                                                                                                                                                                 |
| []                                                                                                                          |
+-----------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
[ {border="0"} ]Note: Once the data source bounded with OLAP Client, a default report will be created and the OLAP Client will populated with that default report initially.
