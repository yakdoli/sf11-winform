---
title: xhtml.md
original_path: c:/workspace/sf11-winform/WinForms_Docs\99_Uncategorized\xhtml.md
...
[·      ]It guarantees that the elements in your pages are well formed.

[·      ]Since many browsers are increasingly moving towards supporting XHTML, it ensures that your pages are rendered consistently in all browsers.

[·      ]It helps to make pages conform more readily to the accessibility standards.

[·      ]XHTML is extensible, allowing the definition of new elements.

[·      ]An XHTML page is much easier to read programmatically, for situations in which the Web Page is processed by a computer instead of being read by users, and it can be manipulated using transformations.
