---
title: rangecalculationmode1.md
original_path: c:/workspace/sf11-winform/WinForms_Docs\99_Uncategorized\rangecalculationmode1.md
...
|                                   |                                                                                                                                                                                                                                                               |
|                                   | [·      ]ConsistentAcrossChartTypes: All charts will be drawn from the axis start point. In this case, column charts will also be drawn with the same range as other charts, making the first and last segments hidden partially |
|                                   |                                                                                                                                                                                                                                                               |
...
| []                                                                                                                                         |
|                                                                                                                                                                                |
| [// Creating an instance for the Chart and Chart Area.]                                                                      |
|                                                                                                                                                                                |
...
| []                                                                                                                                         |
|                                                                                                                                                                                |
| [// Initializing the Range Calculation Mode values.]                                                                         |
|                                                                                                                                                                                |
