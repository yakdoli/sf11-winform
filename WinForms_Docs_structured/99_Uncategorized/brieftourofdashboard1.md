---
title: brieftourofdashboard1.md
original_path: c:/workspace/sf11-winform/WinForms_Docs\99_Uncategorized\brieftourofdashboard1.md
...
1.   **[File ]**- Allows you to exit the dashboard, which can alternatively be done by clicking {border="0"} on the right top corner of dashboard.
...
-This lists the Add-on utilities that will help the user to utilize additional product services from Syncfusion. All the three editions offer different add-ons for users.

- This accordion set displays the common utilities for all editions:

 

-This installer allows you to configure Syncfusion controls for various .NET frameworks in combination with compatible Visual Studio versions.

-This utility allows the user to manage installation and uninstallation of Syncfusion Essential Studio assemblies in the GAC and in the Assemblies folders.

 -- This utility allows you to build or debug assemblies using the source installed in the Essential Studio's installed location.

-This provides access to view the online documentation and installed documentation.

-This allows you to manage the licensing information such as the validity of license key and also the products that are licensed with this key.

 -- This allows you to navigate to the Software License Agreement.
...
[·      ][[Sales FAQ]{.UGHyperlink}](http://www.syncfusion.com/sales/faq)[[ ]]{.MsoHyperlink}- Clicking this link directs you to FAQ page, which lists common sales related queries and other sales contact information.

[·      ][[Contact Support]{.UGHyperlink}](http://www.syncfusion.com/Account/Logon?ReturnUrl=%2fsupport%2fdirecttrac)[ ]{.UGHyperlink}- Clicking this link directs you to Direct-Trac Login page to contact our support team.

[·      ][Website](http://www.syncfusion.com/)[ ]{.UGHyperlink}- Clicking this link directs you to Syncfusion website.
