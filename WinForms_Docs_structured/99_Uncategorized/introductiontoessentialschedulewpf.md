---
title: introductiontoessentialschedulewpf.md
original_path: c:/workspace/sf11-winform/WinForms_Docs\99_Uncategorized\introductiontoessentialschedulewpf.md
...
[·      ]**Schedule Type** - Provides 5 different types of viewing the calendar,
...
[·      ]**Time Interval** - Provides various time interval options to show in the time slots.

[·      ]**Data Binding** - Bind to any **IEnumerable** source and generate appointments.

[·      ]**Add / Edit / Delete Appointments** - **CUD** operations on appointments.

 


          [][***[Note]***]{.NoteChar}[: ]These features can be turned off optionally.
