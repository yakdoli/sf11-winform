---
title: builder16.md
original_path: c:/workspace/sf11-winform/WinForms_Docs\99_Uncategorized\builder16.md
...
To create a StackingArea100 chart through Builder:
...
3.   Add the **Series** to the **ChartModel** and set the series type to **StackingArea100**, and add the **Points** to the series and set the style.
...
|                                                                                                                                                                                                                                                                                         |
| [                **    series.Add().Type(Syncfusion.Windows.Forms.Chart.[ChartSeriesType].**][ ]**[StackingArea100)]**             |
|                                                                                                                                                                                                                                                                                         |
| [                                .Text([\"Server 1\"])]                                                                                                                                                                     |
|                                                                                                                                                                                                                                                                                         |
| [                                .Points(point =\>]                                                                                                                                                                                                 |
...
Figure 103: A 100 percent StackedArea chart
