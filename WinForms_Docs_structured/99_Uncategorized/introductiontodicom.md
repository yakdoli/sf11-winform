---
title: introductiontodicom.md
original_path: WinForms_Docs/99_Uncategorized/introductiontodicom.md
...
## Introduction to DICOM {#introduction-to-dicom style="tab-stops: 0pt"}
