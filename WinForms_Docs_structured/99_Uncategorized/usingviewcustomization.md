---
title: usingviewcustomization.md
original_path: c:/workspace/sf11-winform/WinForms_Docs\99_Uncategorized\usingviewcustomization.md
...
| [       })]                                                                                                                                                                                                                                   |
|                                                                                                                                                                                                                                                                                            |
| **[.ScheduleMode([ScheduleMode].Vertical)]**                                                                                                                                                                          |
|                                                                                                                                                                                                                                                                                            |
...
8.   Run the application. The Schedule will appear as shown below when **ScheduleMode** property is in **Vertical** mode.[]
