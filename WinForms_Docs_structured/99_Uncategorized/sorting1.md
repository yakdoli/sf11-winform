---
title: sorting1.md
original_path: c:/workspace/sf11-winform/WinForms_Docs\99_Uncategorized\sorting1.md
...
[The ][JSON mode][ of sorting provides an efficient way to retrieve sorted data as JSON objects. The advantage of this approach is that only data is updated and the client-side grid refreshes itself to display the updated data. This is AJAX at its best. ][]
