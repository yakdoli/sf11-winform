---
title: contentcontrol.md
original_path: WinForms_Docs/99_Uncategorized/contentcontrol.md
...
{border="0"}Note: Currently Essential DocIO does not provide support to edit/modify the Content controls. Track changes information will not be preserved using DocIO.
