---
title: projectreference.md
original_path: c:/workspace/sf11-winform/WinForms_Docs\99_Uncategorized\projectreference.md
...
{border="0"}Note: when you copy the above folder (any time you add a T4 template(.tt)  file) into the project, you will see warnings asshown in the following screenshot:
