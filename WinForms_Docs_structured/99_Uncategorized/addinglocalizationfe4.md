---
title: addinglocalizationfe4.md
original_path: c:/workspace/sf11-winform/WinForms_Docs\99_Uncategorized\addinglocalizationfe4.md
...
| [            {]                                                                                                                                                    |
|                                                                                                                                                                                                                     |
| [                [this].pivotGrid.FlowDirection = System.Windows.[FlowDirection].RightToLeft;]                        |
|                                                                                                                                                                                                                     |
| [            }]                                                                                                                                                    |
+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
