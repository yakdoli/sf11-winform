---
title: creatingplatformapplication.md
original_path: c:/workspace/sf11-winform/WinForms_Docs\99_Uncategorized\creatingplatformapplication.md
...
4.   Now you need to deploy Essential Calculate into this Windows application. Refer  topic for detailed information.
...
2.   Now you need to deploy Essential Calculate into this ASP.NET application. Refer  topic for detailed information.
...
4.   Now you need to deploy Essential Calculate into this WPF application. Refer  topic for detailed information.
