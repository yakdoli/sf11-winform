---
title: doughnutcoeficient.md
original_path: c:/workspace/sf11-winform/WinForms_Docs\99_Uncategorized\doughnutcoeficient.md
...
| **[]**                                                                                                                  |
|                                                                                                                                                                           |
| [this][.ChartWebControl1.Series\[0\].ConfigItems.PieItem.DoughnutCoeficient = 0.5f;] |
+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
| **[]**                                                                                                             |
|                                                                                                                                                                      |
| [Me][.ChartWebControl1.Series(0).ConfigItems.PieItem.DoughnutCoeficient = 0.5f] |
+----------------------------------------------------------------------------------------------------------------------------------------------------------------------+
