---
title: behaviorsettings.md
original_path: WinForms_Docs/99_Uncategorized/behaviorsettings.md
...
| []                                                                                                             |
|                                                                                                                                                                 |
| [this][.AutoCompleteTextBox1.IntiallyShown = [true];] |
+-----------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
| []                                                                                                               |
|                                                                                                                                                                   |
| [Private][ AutoCompleteTextBox1.IntiallyShown = [True]] |
+-------------------------------------------------------------------------------------------------------------------------------------------------------------------+
