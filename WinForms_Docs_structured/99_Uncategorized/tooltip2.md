---
title: tooltip2.md
original_path: c:/workspace/sf11-winform/WinForms_Docs\99_Uncategorized\tooltip2.md
...
By using the ShowToolTips property, you can enable the Tooltip for all chart regions. To render all the ChartRegions, you need to set the ChartModel.Calcregions property to true.
