---
title: spacingbetweenpoints.md
original_path: c:/workspace/sf11-winform/WinForms_Docs\99_Uncategorized\spacingbetweenpoints.md
...
| []                                                                                                    |
|                                                                                                                                                         |
| [this][.ChartWebControl1.SpacingBetweenPoints = 70;] |
+---------------------------------------------------------------------------------------------------------------------------------------------------------+
...
| **[]**                                                                                             |
|                                                                                                                                                      |
| [Me][.ChartWebControl1.SpacingBetweenSeries = 70] |
+------------------------------------------------------------------------------------------------------------------------------------------------------+
