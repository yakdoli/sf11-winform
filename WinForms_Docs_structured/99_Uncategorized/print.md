---
title: print.md
original_path: c:/workspace/sf11-winform/WinForms_Docs\99_Uncategorized\print.md
...
Table 15: Print - Properties**[]**


  ----------- ----------------------------------------------------- ---------------------- -------------------------------------- ------------
  Property    Description                                           Type of the property   Value it accepts                       Dependency
  ShowPrint   Used to enable the Print icon on Viewstrip toolbar.   Boolean                [True/False]   NA
  ----------- ----------------------------------------------------- ---------------------- -------------------------------------- ------------
