---
title: adomdnetassemblyandsetupfilesinformation.md
original_path: WinForms_Docs/99_Uncategorized/adomdnetassemblyandsetupfilesinformation.md
...
{border="0"}Note: By default the below setup files will be installed while installing Syncfusion' Essential studio setup for BI edition:
