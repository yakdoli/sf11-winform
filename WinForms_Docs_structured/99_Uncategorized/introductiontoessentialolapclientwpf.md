---
title: introductiontoessentialolapclientwpf.md
original_path: WinForms_Docs/99_Uncategorized/introductiontoessentialolapclientwpf.md
...
[Slice and Dice]{.UGHyperlink} [[]]{.underline} **[ ]** [- ]You can slice and dice the Cube Data Base.

[Saving]{.UGHyperlink} **[]the current session** - You can save your current session in an XML file or in a Stream for future use and reload it whenever needed.

**Pivot Toggling** - You can easily toggle the pivot if required by the click of button.

[Filter]{.UGHyperlink} **[]** and**[]**[Sorting]{.UGHyperlink}[ - ]You can specify filters and sorting criteria by using the dialog boxes provided.

[Export]{.UGHyperlink} **[]support** - You can also export the[][OlapGrid]{.UGHyperlink}[]and [OlapChart]{.UGHyperlink}[]to MS-Excel and other supported image formats. 
