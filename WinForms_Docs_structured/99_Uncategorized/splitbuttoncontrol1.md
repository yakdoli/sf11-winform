---
title: splitbuttoncontrol1.md
original_path: WinForms_Docs/99_Uncategorized/splitbuttoncontrol1.md
...
## SplitButton Control {#splitbutton-control style="tab-stops: 0pt"}
