---
title: performance8.md
original_path: WinForms_Docs/99_Uncategorized/performance8.md
...
{border="0"}Note: For more details, refer to the following section:
...
[Grid Data Bound Grid Performance][[ ]]{.underline}and [Performance][[]]{.underline}
