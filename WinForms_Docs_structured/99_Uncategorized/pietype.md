---
title: pietype.md
original_path: c:/workspace/sf11-winform/WinForms_Docs\99_Uncategorized\pietype.md
...
| **[]**                                                                                                                                          |
|                                                                                                                                                                                                   |
| [this][.ChartWebControl1.Series\[0\].ConfigItems.PieItem.PieType=[ChartPieType].Bevel;] |
+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
| **[]**                                                                                                                                       |
|                                                                                                                                                                                                |
| [Me][.ChartWebControl1.Series(0).ConfigItems.PieItem.PieType = [ChartPieType].Bevel] |
+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
