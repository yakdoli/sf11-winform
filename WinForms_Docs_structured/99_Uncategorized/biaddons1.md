---
title: biaddons1.md
original_path: WinForms_Docs/99_Uncategorized/biaddons1.md
...
{border="0"}Note:[ ]The version number in the tags has to be changed to whatever version you are linking to.
