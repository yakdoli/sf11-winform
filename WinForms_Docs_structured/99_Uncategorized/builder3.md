---
title: builder3.md
original_path: c:/workspace/sf11-winform/WinForms_Docs\99_Uncategorized\builder3.md
...
To create a Bar chart through Builder:
...
3.   Add the **Series** to the ChartModel and set the series type to **Bar**, and add the **Points** to the series and set the style.
...
|                                                                                                                                                                                                                                                                                         |
| [    **                series.Add().Type(Syncfusion.Windows.Forms.Chart.[ChartSeriesType].Bar)**]                                                                                                                           |
|                                                                                                                                                                                                                                                                                         |
| [                                .Text([\"Server 1\"])]                                                                                                                                                                     |
|                                                                                                                                                                                                                                                                                         |
| [                                .Points(points =\>]                                                                                                                                                                                                |
