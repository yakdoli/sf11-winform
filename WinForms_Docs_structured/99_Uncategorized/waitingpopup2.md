---
title: waitingpopup2.md
original_path: WinForms_Docs/99_Uncategorized/waitingpopup2.md
...
[·      ]Customizable image, color, and opacity.

[·      ]Support for displaying when the page loads.

[·      ]A rich set of client-side methods.
