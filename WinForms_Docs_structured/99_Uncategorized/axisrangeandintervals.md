---
title: axisrangeandintervals.md
original_path: c:/workspace/sf11-winform/WinForms_Docs\99_Uncategorized\axisrangeandintervals.md
...
|                                                                                                                                                                                                                                                                                                                              |
| [this][.ChartWebControl1.PrimaryXAxis.DateTimeRange = [new] [ChartDateTimeRange](baseDate.AddMonths(-1), baseDate.AddMonths(6), 1, [ChartDateTimeIntervalType].Months);] |
|                                                                                                                                                                                                                                                                                                                              |
| []                                                                                                                                                                                                                                                                                       |
|                                                                                                                                                                                                                                                                                                                              |
...
|                                                                                                                                                                                                                                                                                                                              |
| [this][.ChartWebControl1.PrimaryYAxis.Range = [new] [MinMaxInfo](1, 20, 2);]                                                                                                                  |
|                                                                                                                                                                                                                                                                                                                              |
| []                                                                                                                                                                                                                                                                                       |
|                                                                                                                                                                                                                                                                                                                              |
| [// Customize the Y axis range and interval which has points of type double]                                                                                                                                                                                               |
...
| [this][.ChartWebControl1.PrimaryXAxis.RangeType = [ChartAxisRangeType].Set;]                                                                                                                                    |
|                                                                                                                                                                                                                                                                                                                              |
| [this][.ChartWebControl1.PrimaryXAxis.Range = [new] [MinMaxInfo](0, 6, 1);]                                                                                                                   |
+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
|                                                                                                                                                                                                                                                                                                     |
| [Me][.ChartWebControl1.PrimaryXAxis.DateTimeRange = [New] [ChartDateTimeRange(baseDate.AddMonths(-1), baseDate.AddMonths(6), 1, ChartDateTimeIntervalType.Months)]] |
|                                                                                                                                                                                                                                                                                                     |
| []                                                                                                                                                                                                                                                              |
|                                                                                                                                                                                                                                                                                                     |
| [\' Customize the Y axis range and interval which has points of type double]                                                                                                                                                                      |
...
|                                                                                                                                                                                                                                                                                                     |
| [Me][.ChartWebControl1.PrimaryYAxis.Range = [New] [MinMaxInfo(1, 20, 2)]]                                                                                           |
|                                                                                                                                                                                                                                                                                                     |
| []                                                                                                                                                                                                                                                              |
|                                                                                                                                                                                                                                                                                                     |
...
| [Me][.ChartWebControl1.PrimaryXAxis.RangeType = [ChartAxisRangeType].Set]                                                                                                                |
|                                                                                                                                                                                                                                                                                                     |
| [Me][.ChartWebControl1.PrimaryXAxis.Range = [New] [MinMaxInfo](0, 6, 1)]                                                                                            |
+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
