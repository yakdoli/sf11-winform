---
title: usingviewcustomization17.md
original_path: c:/workspace/sf11-winform/WinForms_Docs\99_Uncategorized\usingviewcustomization17.md
...
| [};]                                                                                                                                                                                                                                                 |
|                                                                                                                                                                                                                                                                                                   |
| [                // Adding context menu items into view data]                                                                                                                                                                          |
|                                                                                                                                                                                                                                                                                                   |
| [ViewData\[[\"contextMenus\"]\] = [new] [List]\<[ContextMenuItem]\>() { newapp, recurMnu, todayMnu, openMnu, quickMnu, delMnu, menuItem1, menuItem2 };] |
|                                                                                                                                                                                                                                                                                                   |
| [                                [return] View(data);]                                                                                                                                                                          |
|                                                                                                                                                                                                                                                                                                   |
| [        }]                                                                                                                                                                                                                                          |
