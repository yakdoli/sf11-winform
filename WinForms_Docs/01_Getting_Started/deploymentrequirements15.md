...
[](ms-xhelp:///?Id=ce8a5afc-d7b0-4b8e-bb40-1075cebe89b9){#D2HPrevious .D2HPreviousEnabled}  [](ms-xhelp:///?Id=68bc3a15-85cd-4806-bb02-b9f5381913a5){#D2HNext .D2HNextEnabled}
:::
::::
:::::
...
While deploying an application that references Syncfusion Essential Grid Silverlight assembly, the following dependencies must be included in the distribution.
...
[]{#p8}[]{style="FONT-FAMILY: 'Trebuchet MS','sans-serif'; FONT-SIZE: 9pt"} 
