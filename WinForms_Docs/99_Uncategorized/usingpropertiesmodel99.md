...
2.   Set the **ShowToolTip** property and pass the instance through the view-specific data to the view.
...
|                                                                                                                                                                           |
| [            **slider.ShowToolTip = [true]{style="COLOR: blue"};**]{style="FONT-FAMILY: 'Courier New'"}                                                                   |
|                                                                                                                                                                           |
...
4.   Build and run the application in an emulator.

The following figure shows the slider output.

**[]{style="FONT-FAMILY: 'Calibri','sans-serif'; FONT-SIZE: 12pt"}**  

[ ![Description: C:\\Users\\krishnarajd\\Desktop\\tooltip.png](ImagesExt/image103_217.jpg){border="0"} ]{style="LINE-HEIGHT: 115%; FONT-FAMILY: 'Calibri','sans-serif'; FONT-SIZE: 11pt"} []{style="LINE-HEIGHT: 115%; FONT-FAMILY: 'Calibri','sans-serif'; FONT-SIZE: 11pt"}

Figure 135: Slider with tooltip[]{style="FONT-FAMILY: 'Calibri','sans-serif'; FONT-SIZE: 11pt"}
