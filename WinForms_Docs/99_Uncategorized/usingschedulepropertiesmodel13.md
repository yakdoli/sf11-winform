...
+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| **[View\[cshtml\][]{.MsoIntenseEmphasis}]{style="FONT-FAMILY: 'Calibri','sans-serif'"}**                                                                                                                    |
|                                                                                                                                                                                                             |
...
|                                                                                                                                                                                                                                            |
| **[            scheduleModel.TimeMode = [ScheduleTimeMode]{style="COLOR: #2b91af"}.Hours24;]{style="FONT-FAMILY: 'Calibri','sans-serif'"}**                                                                                                |
|                                                                                                                                                                                                                                            |
