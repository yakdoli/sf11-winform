...
1.   In the **Controller**, create an instance of PercentTextBoxModel; define the **Style** property, and pass the instance through the view-specific data to the view.[]{style="FONT-FAMILY: 'Calibri','sans-serif'"}
...
|                                                                                                                                                                                                                                                                                                 |
| [            ]{style="FONT-FAMILY: Consolas; FONT-SIZE: 9.5pt"} [PercentTextBoxModel]{style="FONT-FAMILY: Consolas; COLOR: #2b91af; FONT-SIZE: 9.5pt"} [ myModel = [new]{style="COLOR: blue"}[PercentTextBoxModel]{style="COLOR: #2b91af"}();]{style="FONT-FAMILY: Consolas; FONT-SIZE: 9.5pt"} |
|                                                                                                                                                                                                                                                                                                 |
| [            myModel.Style = MobStyle.OnDemand;]{style="FONT-FAMILY: Consolas; FONT-SIZE: 9.5pt"} []{style="FONT-FAMILY: 'Times New Roman','serif'; FONT-SIZE: 12pt"}                                                                                                                           |
|                                                                                                                                                                                                                                                                                                 |
| [            ViewData\[[\"myPercent\"]{style="COLOR: #a31515"}\] = myModel;]{style="FONT-FAMILY: Consolas; FONT-SIZE: 9.5pt"} []{style="FONT-FAMILY: 'Times New Roman','serif'; FONT-SIZE: 12pt"}                                                                                               |
|                                                                                                                                                                                                                                                                                                 |
...
![](ImagesExt/image103_169.jpg){border="0"}
