...
[](ms-xhelp:///?Id=406b2280-7dbb-4ac8-8eeb-a2cd9fc98955){#D2HPrevious .D2HPreviousEnabled}  [](ms-xhelp:///?Id=da36b9c7-3e53-42d5-b02c-dbead57fef4f){#D2HNext .D2HNextEnabled}
:::
::::
:::::
...
[·      ]{style="FONT-FAMILY: Symbol"}Retrieve the bounds of each section of the Pie, Funnel, or Pyramid charts.

[·      ]{style="FONT-FAMILY: Symbol"}Show the series name as a title for individual sections of a Pie, Funnel, and Pyramid chart types.

[·      ]{style="FONT-FAMILY: Symbol"}Draw the Pie series with the same radius.[]{style="FONT-FAMILY: 'Calibri','sans-serif'"}
