...
![](ImagesExt/image59_24.jpg){border="0"}
...
![](ImagesExt/image59_1.jpg){border="0"}Note : A sample that illustrates the FastLine chart type to load 100K chart points is available in the sample installation. Refer the Chart Performance\\Chart Performance Demo in our installation for complete source code.
:::
